...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %> 
    ...
    <div id="cart" class="section">
		...
		<p><span class="total">0.00</span>&nbsp;<spring:message code="label.currency"/></p><hr> 
	    
	    <label><spring:message code="label.cart.select"/>:</label>
	    ...
	    <div class="table-responsive table-items">
	         <table class="table table-sm text-center table-striped table-hover edit">
	             <tr class="primary">
	                 <th class="text-left"><spring:message code="label.product.pnumber"/></th>
	                 <th class="text-left"><spring:message code="label.product.pdescription"/></th>
	                 <th class="text-center"><spring:message code="label.cart.qty"/></th>
	                 <th class="text-right"><spring:message code="label.cart.unitusd"/></th>
	                 <th class="text-right"><spring:message code="label.cart.totalusd"/></th>
	             </tr>      
	        </table>     
	    </div>  
