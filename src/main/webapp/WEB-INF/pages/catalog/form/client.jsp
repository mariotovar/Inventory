...
<form:form class="catalog" method="POST" modelAttribute="client">
	...
	<div class="secciones row">
        <div class="col-12 col-md-12 mt-2">
	        <h6 class="titulos mt-1">
	        	<form:label path="emailCC1"><spring:message code="label.client.emailCC"/> (1)</form:label>
	        </h6>
     ...
     <div class="secciones row">
   	<div class="col-12 col-md-12 mt-2">
	        <h6 class="titulos mt-1">
	        	<form:label path="emailCC2"><spring:message code="label.client.emailCC"/> (2)</form:label>
	        </h6>
    ...
    <div class="secciones row">
        <div class="col-12 col-md-6 mt-2">
			<h6 class="titulos mt-1">
				<form:label path="localPhone"><spring:message code="label.client.localphone"/></form:label>	
			</h6>
			<form:input path="localPhone" type="text" class="form-control"  maxlength="20"/>
        </div>        
        <div class="col-12 col-md-6 mt-2">
        	<h6 class="titulos mt-1">
        		<form:label path="mobilePhone"><spring:message code="label.client.mobilephone"/></form:label>
        	</h6>
...
<div class="secciones row">
        <div class="col-12 col-md-12 mt-2">
	        <h6 class="titulos mt-1">
	        	<form:label path="contact"><spring:message code="label.client.contact"/></form:label>
	        </h6>
