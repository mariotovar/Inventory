	...
	<div id="products" class="secciones">
	     ...
	     <div class="table-responsive table-items">
	         <table class="table table-sm text-center table-striped table-hover">
	             <tr class="primary">
	             	<!-- Incluir Lote para seleccionar y stoc actual -->
	                 <th>Part Number</th>
     ...
     <div id="confirmation" class="step secciones">
          ...
          <div class="text-right">
                ...
                <button type="button" class="btn btn-success btn-sm"><span><i class="fas fa-save"></i></span> Generar Salida al Inventario</button>
          </div>              
