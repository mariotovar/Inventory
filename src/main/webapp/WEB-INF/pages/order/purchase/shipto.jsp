	...
	<form:form class="catalog order" method="POST" modelAttribute="purchaseOrder">
	    ...
	    <div class="secciones row">
	        <div class="col-12 col-md-12 mt-2">
				...
				<form:select id="shiptoPK" path="shipto.pk" data-pk="${purchaseOrder.shipto.pk}">
				<c:forEach items="${lstShipto}" var="shipto">
                  <option value="${shipto.pk}">
                  	${shipto.value} | ${shipto.address}, ${shipto.zip}, ${shipto.state}, ${shipto.country}
                  </option>
                  </c:forEach>
                </form:select>
	        </div>  
...
$(document).ready(function(){			
	...
	$('#shiptoPK option[value='+pkShipto+']').attr('selected', 'selected');
